...
import HeroBannerImage from '../assets/images/newBanner.jpg';
...
const HeroBanner = () => {
  return (
    <Box sx={{mt:{lg:'212px', xs:'70px'}, ml:{sm:'50px'}}} position="relative" p="20px">
        ...
        <img src={HeroBannerImage} alt="banner" style={{borderBottomLeftRadius:'100px'}} className="hero-banner-img" />
    </Box>
)
